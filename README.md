A company mangament websiste using HTML, CSS, JAVA, using a mySQL database and SQL functions. It isn't completely finished but you can manage employee details such as personal details, 
